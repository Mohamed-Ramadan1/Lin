...
//   return (
//     <footer className="flex items-center justify-between flex-wrap p-3 bg-gray-800 text-white w-[100%] static ">
...
function DashboardFooter() {
  return (
    <footer className="fixed bottom-0 left-0 w-full p-3 bg-gray-800 text-white">
