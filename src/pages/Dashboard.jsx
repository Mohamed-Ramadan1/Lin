    ...
    <>
      <div className="p-5">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 mt-5">
          <div class="p-5 rounded-lg shadow rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mt-5">
          ...
          <div class="rounded-lg p-5 rounded-5 shadow rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            >
              <h4
                class="text-title
                    -md font-bold text-black dark:text-white"
              >
                Total Revenue
              </h4>
              <span class="text-sm font-medium text-meta-3 undefined ">
