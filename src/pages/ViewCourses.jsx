      ...
      <div className="container max-w-[1400px] m-auto flex flex-col gap-10 flex-col justify-center items-center">
        <div className="title flex flex-col items-start gap-[15px]">
          ...
          <p className="text-base text-[#8d8d8d]">
            All Business courses" encompass a wide array of educational
            offerings designed to equip individuals with the knowledge and
            skills necessary to thrive in various aspects of the business world.
            These courses cover topics ranging from entrepreneurship and
            management to finance, marketing, and beyond. Here's an overview of
