      ...
      <div className="thumbnail overflow-hidden relative w-full h-[400px] ">
        ...
        <div className="button-content z-10 absolute p-[20px] bottom-0 w-full flex items-end justify-between">
          <div className="image-teatcher flex gap-3 justify-center items-center">
            ...
            />
            <div className="info">
              <h2 className="text-2xl font-bold text-[#fff]">Ahmed Magdy</h2>
              <span className="text-base text-[#fff]">UI UX Design</span>
            </div>
          </div>
          <div className="num-student flex gap-3 justify-center items-center">
            ...
            <div>
              <span className="text-[20px] text-[#fff]">5,455 </span>{" "}
