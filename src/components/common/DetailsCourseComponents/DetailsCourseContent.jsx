  ...
  return (
    <div className="details w-full flex gap-[40px] flex-col items-start">
      ...
      <div className="flex flex-col gap-3">
        <RatingComponent totalReviews={totalReviews} rating={averageRating} />
      ...
      <WhatWilllearn learningObjectives={learningObjectives} />
      ...
      <RequirementsCourse prerequisites={prerequisites} />
