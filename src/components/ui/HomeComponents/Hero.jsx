            ...
            <div className="container max-w-[1400px] m-auto flex justify-between items-center max-md:flex-col">
                    ...
                    <div className="content relative flex gap-[40px] flex-col justify-end">
                        ...
                        <div className='relative rounded-[10px] max-w-[160px] w-full p-[10px] flex justify-center items-center bg-[#D5FF40] max-sm:hidden'>
                            ...
                            <motion.img initial={{rotate: -260}} animate={{rotate: 90}} transition={{ repeat: Infinity, type: 'spring' }} src={starPlur} alt="" className='absolute right-[-15px] top-[-20px]'/>
                        </div>

                        <div className="info flex gap-[15px] flex-col justify-end">
                            
                            <div className='flex flex-col justify-end'>
                                    <motion.h1 initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}} transition={{delay: .3}} className='text-6xl font-bold'>Free Online Courses</motion.h1>
                                    <motion.h2 initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}} transition={{delay: .4}} className='text-[55px] font-[500] max-sm:text-[35px] max-sm:mt-[10px]'>With Certificates</motion.h2>
                            </div>
                    ...
                    <motion.div initial={{opacity: 0, x: 50}} animate={{opacity: 1, x: 0}} transition={{delay: .3}} className="imageHero relative">
